...
//    @Autowired
    ...
    public static String sendPutToThingsboard(String url, Map<String,String> headers, JsonObject requestBody) throws Exception{
        String str ;
        if(requestBody==null){
            str = "";
        }else{
    ...
    public static String sendDeletToThingsboard(String url) throws Exception{
        Request.Builder buider = new Request.Builder()
                .url(url)
                .delete() ;
    ...
    public static String sendGetToThingsboard(String url, Map<String,String> headers) throws Exception{
